...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/MarketPlace/edukasi.css') }}">
@endpush
...
<body>
    ...
    <section class="edukasi-hero">
        <div class="edukasi-hero-bg">
            <img src="{{ asset('images/MarketPlace/forest0.png') }}" alt="Climate Education">
        </div>
        <div class="container">
    ...
    <!-- Custom JS -->
    <script src="{{ asset('js/MarketPlace/edukasi.js') }}"></script>
@endsection
