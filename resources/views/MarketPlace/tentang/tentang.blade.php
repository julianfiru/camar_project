...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/MarketPlace/tentang.css') }}">
@endpush
...
<section class="tentang-hero" id="tentang">
    <div class="tentang-hero-bg">
        <img src="{{ asset('images/MarketPlace/forest0.png') }}" alt="Hero Background">
    </div>
    <div class="container">
...
@push('scripts')
<script src="{{ asset('js/MarketPlace/tentang.js') }}"></script>
@endpush