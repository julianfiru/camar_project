...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/MarketPlace/landing.css') }}">
@endpush
...
@section('content')
    ...
    <section class="hero-section" id="home">
        <div class="hero-background">
            <img src="{{ asset('images/MarketPlace/mangrove0.png') }}" alt="Mangrove Background">
        </div>
...
@push('scripts')
<script src="{{ asset('js/MarketPlace/landing.js') }}"></script>
@endpush