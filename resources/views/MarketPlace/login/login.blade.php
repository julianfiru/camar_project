...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/MarketPlace/login.css') }}">
@endpush
        ...
        <div class="login-form-section">
            <div class="login-header">
                <div class="login-logo">
                    <img src="{{ asset('images/MarketPlace/logo-camar.svg') }}" alt="CAMAR Logo">
                </div>
...
@push('scripts')
<script src="{{ asset('js/MarketPlace/login.js') }}"></script>
@endpush