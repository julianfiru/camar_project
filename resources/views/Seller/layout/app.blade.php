            ...
            <aside class="sidebar d-flex flex-column flex-shrink-0 vh-100 fixed-top" id="sidebar">
                ...
                <ul class="nav nav-pills flex-column mb-auto w-100 p-0">
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.dashboard') }}" class="nav-link d-flex align-items-center" data-page="dashboard">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.profil') }}" class="nav-link d-flex align-items-center" data-page="profile">
                            <svg class="bi me-3" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.proyek') }}" class="nav-link d-flex align-items-center" data-page="projects">
                            <svg class="bi me-3" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.penjualan') }}" class="nav-link d-flex align-items-center" data-page="sales">
                            <svg class="bi me-3" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.customer') }}" class="nav-link d-flex align-items-center" data-page="sales">
                    ...
                    <li class="nav-item mb-2">
                        <a href="{{ route('seller.performa') }}" class="nav-link d-flex align-items-center" data-page="performance">
